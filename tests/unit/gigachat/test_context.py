...
def test_set_values() -> None:
    ...
    chat_completions_url_token = chat_completions_url_cvar.set("/new/chat-completions/url")
    ...
    try:
        ...
        assert chat_completions_url_cvar.get() == "/new/chat-completions/url"
    finally:
        ...
        chat_completions_url_cvar.reset(chat_completions_url_token)
