...
def test_gigachat_constructor_explicit_params() -> None:
    ...
    assert client._settings.credentials == "test_credentials"
    assert client._settings.scope == "test_scope"
    assert client._settings.access_token == "test_token"
    ...
    assert client._settings.password == "test_password"
    ...
    assert client._settings.key_file_password == "key_password"
