...
| `http2`            | нет          | Использовать ли HTTP/2 для запросов к GigaChat API. Необходимо для работы с потоковой передачи токенов, по умолчанию выключено.                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
## Потоковая передача и HTTP/2

Для работы с потоковой передачей токенов требуется поддержка HTTP/2. Включите HTTP/2 при инициализации:
