...
* [работу с функциями](examples/example_functions.py);
  ...
  Работа с функциями доступна в версии библиотеки 0.1.14 и выше. Эта функциональность находится в стадии тестирования. Способ создания и описания функций может измениться в более новых версиях библиотеки.
...
> [!TIP]
> Эти и другие примеры работы с библиотекой gigachat — в папке [examples](examples/README.md).
