...
class GigaChatSyncClient(_BaseClient):
    ...
    @_with_retry
    @_with_auth
    def validate_function(self, function: Union[CustomFunction, Dict[str, Any]]) -> FunctionValidationResult:
...
class GigaChatAsyncClient(_BaseClient):
    ...
    @_awith_retry
    @_awith_auth
    async def avalidate_function(self, function: Union[CustomFunction, Dict[str, Any]]) -> FunctionValidationResult:
        """Validate a GigaChat function description."""
