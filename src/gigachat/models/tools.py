...
AICheckModel = Literal["GigaCheckClassification", "GigaCheckDetection"]
...
class AICheckResult(APIResponse):
    ...
    ai_intervals: Optional[List[Tuple[int, int]]] = Field(
...
class BalanceValue(BaseModel):
    ...
    value: int = Field(description="Amount of available units (e.g. tokens).")
...
class TokensCount(APIResponse):
    ...
    object_: str = Field(default="tokens", alias="object", description="Object type.")
